...
- Components that import `@meshmakers/shared-ui` cannot be tested directly in vitest — use pure logic tests instead; unit tests only, pure logic first (tracked in AB#5075)
